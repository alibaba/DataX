...
//    public static List<TableStoreRange> rangeSplitByCount(TableMeta meta,
//                                                          RowPrimaryKey begin, RowPrimaryKey end, int count) {
//        List<TableStoreRange> results = new ArrayList<TableStoreRange>();
//
//        TableStorePrimaryKeyColumn partitionKey = Common.getPartitionKey(meta);
//
...
//
//            results.add(new TableStoreRange(bPk, ePk));
//        }
//
...
//                TableStoreRange c = results.get(i);
...
//    public static List<TableStoreRange> rangeSplitByPoint(TableMeta meta, RowPrimaryKey beginPK, RowPrimaryKey endPK,
...
//            TableStoreRange item = new TableStoreRange(
...
//        TableStoreRange first = results.get(0);
//        TableStoreRange last = results.get(results.size() - 1);
//
