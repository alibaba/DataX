...
//    public static TableStoreRange checkRangeAndGet(TableMeta meta, List<PrimaryKeyValue> begin, List<PrimaryKeyValue> end) {
//        TableStoreRange range = new TableStoreRange();
...
//     * @param points
//     */
//    public static void checkInputSplitPoints(TableMeta meta, TableStoreRange range, Direction direction, List<PrimaryKeyValue> points) {
//        if (null == points || points.isEmpty()) {
//            return;
//        }
//
//        TableStorePrimaryKeyColumn part = Common.getPartitionKey(meta);
//
//        // 处理第一个
