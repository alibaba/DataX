...
import com.alibaba.datax.common.element.ArrayColumn;
            ...
            try {
                for (int i = 1; i <= columnNumber; i++) {
                    ...
                    switch (columnType) {
                        ...
                        case Types.DOUBLE:
                            if (dataBaseType == DataBaseType.PostgreSQL) {
                                ...
                                if (val != null && val.contains("$")) {
                                    final String replace = val.replace("$", "");
                                    record.addColumn(new DoubleColumn(replace));
                                }
                                else {
                        ...
                        case Types.DATE:
                            if (sourceColumnTypeName.equalsIgnoreCase("year")) {
