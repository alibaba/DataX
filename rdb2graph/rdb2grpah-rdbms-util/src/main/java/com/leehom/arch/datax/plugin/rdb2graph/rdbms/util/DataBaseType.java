...
public enum DataBaseType {
    MySql("mysql", "com.mysql.jdbc.Driver", "select 'x'"),
    Tddl("mysql", "com.mysql.jdbc.Driver", "select 'x'"),
    DRDS("drds", "com.mysql.jdbc.Driver", "select 'x'"),
    Oracle("oracle", "oracle.jdbc.OracleDriver", "select 'x' from dual"),
    SQLServer("sqlserver", "com.microsoft.sqlserver.jdbc.SQLServerDriver", "select x"),
    PostgreSQL("postgresql", "org.postgresql.Driver", "select x"),
    RDBMS("rdbms", "com.alibaba.datax.plugin.rdbms.util.DataBaseType", "select x"),
    DB2("db2", "com.ibm.db2.jcc.DB2Driver", "select x"),
    ADS("ads","com.mysql.jdbc.Driver", "select x"),
    ClickHouse("clickhouse", "ru.yandex.clickhouse.ClickHouseDriver", "select x");
