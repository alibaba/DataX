...
public enum DBUtilErrorCode implements ErrorCode {
    ...
    TABLE_QUERYSQL_MIXED("DBUtilErrorCode-08", "获取数据模式配置错误. 不能同时既配置table又配置querySql"),
    TABLE_QUERYSQL_MISSING("DBUtilErrorCode-09", "获取数据模式配置错误. table和querySql 应该并且只能配置一个."),
    ...
    // graph
    ERROR_LOAD_RDBSCHEMA("DBUtilErrorCode-17", "载入关系模式异常."),
    ;
