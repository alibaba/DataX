 ...
 * @see 	 
 */
public class NodeIndexMapping implements SchemaMapping<NodeIndexMetadata> {

	@Override
	public QueryWrapper mapTo(DbSchema dbSchema, NodeIndexMetadata nindex) {
		IndexMetadata index = nindex.getIndexmd();
		//
		String cql = MessageFormat.format(Neo4jQueryPattern.CREATE_NODE_INDEX, 
				index.getName(), 
