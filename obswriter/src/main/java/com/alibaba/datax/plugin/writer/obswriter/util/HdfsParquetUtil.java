...
public class HdfsParquetUtil {
    ...
    /**
     * 配置writerSliceConfig 适配hdfswriter写obs parquet
    ...
    public static void adaptConfiguration(HdfsWriter.Job hdfsWriterJob, Configuration writerSliceConfig){
        ...
        hadoopConfig.put(Key.FS_OBS_ACCESSKEY,writerSliceConfig.getString(Key.ACCESSKEY));
        hadoopConfig.put(Key.FS_OBS_SECRETKEY,writerSliceConfig.getString(Key.SECRETKEY));
        hadoopConfig.put(Key.FS_OBS_ENDPOINT,writerSliceConfig.getString(Key.ENDPOINT));
