package com.alibaba.datax.plugin.reader.qcubicreader;
...
public class QcubicReader extends Reader {

    private static final DataBaseType DATABASE_TYPE = DataBaseType.Qcubic;
    ...
    public static class Job extends Reader.Job {
        ...
        public void init() {
            ...
            int fetchSize = this.originalConfig.getInt(Constant.FETCH_SIZE,
                    com.alibaba.datax.plugin.reader.qcubicreader.Constant.DEFAULT_FETCH_SIZE);
            if (fetchSize < 1) {
