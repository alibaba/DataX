...
public final class Key {
    ...
    public static String getColumn(Configuration conf) {
        return conf.getString("column","");
    }

    public static String getSearch(Configuration conf) {
        return conf.getString("search", "");
    }
}
