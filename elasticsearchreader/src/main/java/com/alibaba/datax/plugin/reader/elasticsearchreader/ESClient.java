...
public class ESClient {
    ...
    public JsonObject seachDocument(String query, String index_name, String type_name) throws  IOException{
        Search search = new Search.Builder(query).addIndex(index_name).addType(type_name).setParameter(Parameters.SCROLL, "5m").build();
    ...
    public JsonObject searchScroll(String scrollId) throws IOException{
