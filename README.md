...
**该版本新增了clickhousereader实现——2022.8.4。**
...
|              | Cassandra           |     √     |     √     |                [读](https://github.com/alibaba/DataX/blob/master/cassandrareader/doc/cassandrareader.md) 、[写](https://github.com/longmazhanfeng/DataX/blob/master/clickhousewriter/src/main/resources/plugin_job_template.json)                 |
|              | Clickhouse          |     √     |     √     |                [读](https://github.com/longmazhanfeng/DataX/blob/master/clickhousereader/src/main/resources/plugin_job_template.json) 、[写](https://github.com/alibaba/DataX/blob/master/cassandrawriter/doc/cassandrawriter.md)                 |
