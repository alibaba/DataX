...
public class AdbpgWriter extends Writer {
  ...
  public static class Task extends Writer.Task {
    ...
    public void init() {
      ...
      this.adb4pgClientProxy = new Adb4pgClientProxy(writerSliceConfig,
    ...
    public void startWrite(RecordReceiver recordReceiver) {
      this.adb4pgClientProxy
          .startWriteWithConnection(recordReceiver, Adb4pgUtil.getAdbpgConnect(writerSliceConfig));
    }
